namespace YPM.Veri.Kaynak
{
    internal class VtBilgi
    {
        ...
        {
            return @"server=94.73.144.4;database=u7148612_YpmSebil;user=u7148612_Ercet00ilk;password=XVuv62U6;trusted_connection=false;MultipleActiveResultSets=true;";
