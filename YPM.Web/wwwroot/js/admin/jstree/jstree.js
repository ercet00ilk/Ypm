 ...
 */
	...
	// prevent another load? Mayısbe there is a better way?
	if($.jstree) {
		return;
	}
	...
	$.jstree.core.prototype = {
		...
		activate_node : function (obj, e) {
			...
			// ensure last_clicked is still in the DOM, make it fresh (Mayısbe it was moved?) and make sure it is still selected, if not - make last_clicked the last selected node
			 ...
			 * @param {Object} node
			 * @param {Object} event the ooriginal event (if any) which triggered the call (Mayıs be an empty object)
			 */
 ...
 */
	...
	$.jstree.defaults.dnd = {
		...
		drag_selection : true,
		/**
		 * controls whether dnd works on touch devices. If left as boolean true dnd will work the same as in desktop browsers, which in some cases Mayıs impair scrolling. If set to boolean false dnd will not work on touch devices. There is a special third option - string "selected" which means only selected nodes can be dragged on touch devices.
 ...
 * ### Wholerow plugin
 *
 * Makes each node appear block level. Making selection easier. Mayıs cause slow down for large trees in old browsers.
 */
